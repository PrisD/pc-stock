...
## Generación de alertas de stock bajo 
   **Objetivo del módulo**
   ...
   Cuando el stock de un producto sea menor a una cantidad establecida por el usuario, 
    ...
    Le deberá especificar que producto está por debajo del límite y su cantiddad actual 
    que hay del producto.
   
**Algoritmo**
# Módulo: Generar Alerta de Stock Bajo
...
### Nivel 2
2. i) Del movimiento de egreso, chequear el campo id del lote.  
